...
- [x] detail.md / teach.md 反映

### 実機テスト後の改良（2026-06-02 16:19）
- [x] ①二重入力 / ②濁点で旧文字残り を根本修正（input実値ミラー方式に作り直し・冪等）
- [x] ③感度スライダー→ステータスバー右端のセレクト（iOSでロール選択）
- [x] ④2本指ピンチで拡大縮小（Cmd/Ctrl +/-、スクロールと両立）
